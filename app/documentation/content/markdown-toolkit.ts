...
where $n$ is the number of pages and $B$ the total bytes of attachments.`,
        ...
        },
        {
          ...
          text: "The Markdown you type is stored against that macro, and goes when the app is uninstalled. Keep that in mind before putting a critical runbook only in a macro. See the [privacy policy](/privacy/markdown-toolkit).",
        },
      ],
    },
